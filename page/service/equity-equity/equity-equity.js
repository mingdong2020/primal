var postsData = require('../../../data/data-equity-equity.js');
var app = getApp();
Page({
  data: {
    open: false,
    ...
    shareData: {
      ...
      path: '/page/service/equity-equity/equity-equity'
    }      
  },
  tap_ch: function (e) {
    if (this.data.open) {
  ...
  lookdetail: function (e) {
    ...
    wx.navigateTo({
      url: "/page/service/equity-equity-detail/equity-equity-detail?id=" + lookid.id
    })
  },
