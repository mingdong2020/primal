var postsData = require('../../../data/data-equity-broker.js');
var app = getApp();
Page({
  data: {
    open: false,
    ...
    shareData: {
      ...
      path: '/page/service/equity-broker/equity-broker'
    }       
  },
  tap_ch: function (e) {
    if (this.data.open) {
  ...
  lookdetail: function (e) {
    ...
    wx.navigateTo({
      url: "/page/service/equity-broker-detail/equity-broker-detail?id=" + lookid.id
    })
  }, 
