var postsData = require('../../../data/data-equity-private.js');
var app = getApp();
Page({
  data: {
    open: false,
    ...
    shareData: {
      ...
      path: '/page/service/equity-private/equity-private'
    }       
  },
  tap_ch: function (e) {
    if (this.data.open) {
  ...
  lookdetail: function (e) {
    ...
    wx.navigateTo({
      url: "/page/service/equity-private-detail/equity-private-detail?id=" + lookid.id
    })
  }, 
