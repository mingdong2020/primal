var postsData = require('../../../data/data-equity-itloan.js');
var app = getApp();
Page({
  data: {
    open: false,
    ...
    shareData: {
      ...
      path: '/page/service/equity-itloan/equity-itloan'
    }      
  },
  tap_ch: function (e) {
    if (this.data.open) {
  ...
  lookdetail: function (e) {
    ...
    wx.navigateTo({
      url: "/page/service/equity-itloan-detail/equity-itloan-detail?id=" + lookid.id
    })
  }, 
