var postsData = require('../../../data/data-equity-lease.js');
var app = getApp();
Page({
  data: {
    open: false,
    ...
    shareData: {
      ...
      path: '/page/service/equity-lease/equity-lease'
    }  
  },
  tap_ch: function (e) {
    if (this.data.open) {
  ...
  lookdetail: function (e) {
    ...
    wx.navigateTo({
      url: "/page/service/equity-lease-detail/equity-lease-detail?id=" + lookid.id
    })
  },  
