var postsData = require('../../../data/data-equity-factor.js');
var app = getApp();
Page({
  data: {
    open: false,
    ...
    shareData: {
      ...
      path: '/page/service/equity-factor/equity-factor'
    }      
  },
  tap_ch: function (e) {
    if (this.data.open) {
  ...
  lookdetail: function (e) {
    ...
    wx.navigateTo({
      url: "/page/service/equity-factor-detail/equity-factor-detail?id=" + lookid.id
    })
  }, 
