var postsData = require('../../../data/data-equity-pawn.js');
var app = getApp();
Page({
  data: {
    open: false,
    ...
    shareData: {
      ...
      path: '/page/service/equity-pawn/equity-pawn'
    }           
  },
  tap_ch: function (e) {
    if (this.data.open) {
  ...
  lookdetail: function (e) {
    ...
    wx.navigateTo({
      url: "/page/service/equity-pawn-detail/equity-pawn-detail?id=" + lookid.id
    })
  }, 
