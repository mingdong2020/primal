var postsData = require('../../../data/data-equity-invest.js');
var app = getApp();
Page({
  data: {
    open: false,
    ...
    shareData: {
      ...
      path: '/page/service/equity-invest/equity-invest'
    }      
  },
  tap_ch: function (e) {
    if (this.data.open) {
  ...
  lookdetail: function (e) {
    ...
    wx.navigateTo({
      url: "/page/service/equity-invest-detail/equity-invest-detail?id=" + lookid.id
    })
  }, 
